...
class ROS_BaseManager(Node):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.create_subscription(Empty, "/ZeroGLab/Render/EnableRTXRealTime", self.use_RTX_real_time_render, 1)
        self.create_subscription(Empty, "/ZeroGLab/Render/EnableRTXInteractive", self.use_RTX_interactive_render, 1)
        self.create_subscription(Bool, "/ZeroGLab/LensFlare/EnableLensFlares", self.set_lens_flare_on, 1)
        self.create_subscription(Int8, "/ZeroGLab/LensFlare/NumBlades", self.set_lens_flare_num_blade, 1)
        self.create_subscription(Float32, "/ZeroGLab/LensFlare/Scale", self.set_lens_flare_scale, 1)
        self.create_subscription(
            Float32, "/ZeroGLab/LensFlare/ApertureRotation", self.set_lens_flare_aperture_rotation, 1
        )
        self.create_subscription(Float32, "/ZeroGLab/LensFlare/FocalLength", self.set_lens_flare_focal_length, 1)
        self.create_subscription(Float32, "/ZeroGLab/LensFlare/Fstop", self.set_lens_flare_fstop, 1)
        self.create_subscription(
            Float32, "/ZeroGLab/LensFlare/SensorAspectRatio", self.set_lens_flare_sensor_aspect_ratio, 1
        )
        self.create_subscription(Float32, "/ZeroGLab/LensFlare/SensorDiagonal", self.set_lens_flare_sensor_diagonal, 1)
