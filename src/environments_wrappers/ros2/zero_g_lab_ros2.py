...
class ROS_ZeroGLabManager(ROS_BaseManager):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.create_subscription(Bool, "/ZeroGLab/Projector/TurnOn", self.set_projector_on, 1)
        self.create_subscription(Float32, "/ZeroGLab/Projector/Intensity", self.set_projector_intensity, 1)
        self.create_subscription(Float32, "/ZeroGLab/Projector/Radius", self.set_projector_radius, 1)
        self.create_subscription(Pose, "/ZeroGLab/Projector/Pose", self.set_projector_pose, 1)
        self.create_subscription(Bool, "/ZeroGLab/CeilingLights/TurnOn", self.set_ceiling_on, 1)
        self.create_subscription(Float32, "/ZeroGLab/CeilingLights/Intensity", self.set_ceiling_intensity, 1)
        self.create_subscription(Bool, "/ZeroGLab/Curtains/Extend", self.set_curtains_mode, 1)
        self.create_subscription(Int32, "/ZeroGLab/Terrain/Switch", self.switch_terrain, 1)
        self.create_subscription(Bool, "/ZeroGLab/Terrain/EnableRocks", self.enable_rocks, 1)
        self.create_subscription(Int32, "/ZeroGLab/Terrain/RandomizeRocks", self.randomize_rocks, 1)
    ...
    def set_projector_on(self, data: Bool) -> None:
        ...
        self.modifications.append([self.FPLC.turn_projector_on_off, {"flag": data.data}])
    ...
    def set_projector_intensity(self, data: Float32) -> None:
        ...
        self.modifications.append([self.FPLC.set_projector_intensity, {"intensity": data}])
    ...
    def set_projector_radius(self, data: Float32) -> None:
        ...
        self.modifications.append([self.FPLC.set_projector_radius, {"radius": data.data}])
    ...
    def set_projector_color(self, data: ColorRGBA) -> None:
        ...
        self.modifications.append([self.FPLC.set_projector_color, {"color": color}])
    ...
    def set_projector_pose(self, data: Pose) -> None:
        ...
        self.modifications.append([self.FPLC.set_projector_pose, {"position": position, "orientation": orientation}])
    ...
    def set_ceiling_on(self, data: Bool) -> None:
        ...
        self.modifications.append([self.FPLC.turn_room_lights_on_off, {"flag": data.data}])
    ...
    def set_ceiling_intensity(self, data: Float32) -> None:
        ...
        self.modifications.append([self.FPLC.set_room_lights_intensity, {"intensity": data.data}])
    ...
    def set_ceiling_radius(self, data: Float32) -> None:
        ...
        assert data.data > 0.0, "Radius must be greater than 0.0"
        self.modifications.append([self.FPLC.set_room_lights_radius, {"radius": data.data}])
    ...
    def set_ceiling_FOV(self, data: Float32) -> None:
        ...
        self.modifications.append([self.FPLC.set_room_lights_FOV, {"FOV": data.data}])
    ...
    def set_ceiling_color(self, data: ColorRGBA) -> None:
        ...
        for c in color:
            assert 0 <= c <= 1, "The color must be between 0 and 1."
        self.modifications.append([self.FPLC.set_room_lights_color, {"color": color}])
    ...
    def set_curtains_mode(self, data: Bool) -> None:
        ...
        self.modifications.append([self.FPLC.curtains_extend, {"flag": data.data}])
    ...
    def switch_terrain(self, data: Int32) -> None:
        ...
        self.modifications.append([self.FPLC.switch_terrain, {"flag": data.data}])
    ...
    def enable_rocks(self, data: Bool) -> None:
        ...
        self.modifications.append([self.FPLC.enable_rocks, {"flag": data.data}])
        self.trigger_reset = True
    ...
    def randomize_rocks(self, data: Int32) -> None:
        ...
        self.modifications.append([self.FPLC.randomize_rocks, {"num": data}])
        self.trigger_reset = True